-- Sprout care knowledge base seed. Run in the Supabase SQL editor AFTER
-- schema.sql. Safe to re-run (ON CONFLICT DO NOTHING keeps existing rows,
-- including any Claude-generated profiles you don't want overwritten).
-- NOTE: harvest_days (added in migration_002_harvest_days.sql) isn't set by
-- this INSERT — that migration's UPDATE statements backfill it for the 10
-- herbs below by scientific_name, independent of when/how they were seeded.
-- illustration_key values map to components/PlantIllustration.tsx variants:
-- vine | monstera | snake | spider | broadleaf | fiddle | succulent | string
-- | pilea | palm | herb | orchid | fern
...
insert into species_care
  (common_name, scientific_name, illustration_key, difficulty, light,
   ...
   dos, donts, source)
values
('Golden Pothos', 'Epipremnum aureum', 'vine', 'easy', 'medium', 9, 18, 'Average household humidity is fine.',
 ...
 'Pinch the growing tips to keep it bushy, and trim leggy vines back to just above a leaf.',
 null,
...
('Heartleaf Philodendron', 'Philodendron hederaceum', 'vine', 'easy', 'medium', 9, 18, 'Average humidity; enjoys occasional misting.',
 ...
 'Trim vines to encourage fuller growth; remove any yellowing leaves at the base.',
 null,
...
('Marble Queen Pothos', E'Epipremnum aureum \'Marble Queen\'', 'vine', 'easy', 'bright', 8, 16, 'Average humidity is fine.',
 ...
 'Trim back any all-white (no chlorophyll) shoots that struggle to grow.',
 null,
...
('English Ivy', 'Hedera helix', 'vine', 'medium', 'medium', 6, 12, 'Prefers higher humidity than most houseplants.',
 ...
 'Pinch tips regularly to prevent legginess and encourage bushiness.',
 null,
...
('Swiss Cheese Vine', 'Monstera adansonii', 'vine', 'medium', 'medium', 7, 14, 'Enjoys above-average humidity.',
 ...
 'Trim to control size and encourage bushier, more perforated new leaves.',
 null,
...
('Monstera Deliciosa', 'Monstera deliciosa', 'monstera', 'easy', 'bright', 8, 16, 'Average to above-average humidity.',
 ...
 'Trim to control size; wipe or rinse the big leaves so they can breathe.',
 null,
...
('Snake Plant', 'Dracaena trifasciata', 'snake', 'easy', 'low', 18, 35, 'Not fussy about humidity at all.',
 ...
 'Trim any damaged leaves at the base with a clean cut.',
 null,
...
('ZZ Plant', 'Zamioculcas zamiifolia', 'snake', 'easy', 'low', 18, 35, 'Not fussy about humidity.',
 'Fast-draining cactus/succulent mix.', 21, 24,
 ...
 'Trim any yellowing stalks at the base — usually a sign of overwatering.',
 null,
...
('Spider Plant', 'Chlorophytum comosum', 'spider', 'easy', 'medium', 7, 14, 'Average humidity is fine.',
 ...
 'Trim brown leaf tips (usually from tap-water fluoride) with scissors at an angle.',
 null,
...
('Peace Lily', 'Spathiphyllum wallisii', 'broadleaf', 'easy', 'medium', 5, 9, 'Loves higher humidity; mist occasionally.',
 ...
 'Snip spent flower stalks at the base and remove any yellowing leaves.',
 null,
...
('Calathea Orbifolia', 'Calathea orbifolia', 'broadleaf', 'fussy', 'medium', 5, 8, 'Needs high humidity — a pebble tray or humidifier helps a lot.',
 ...
 'Trim any crispy or damaged leaf edges with clean scissors.',
 null,
...
('Prayer Plant', 'Maranta leuconeura', 'broadleaf', 'fussy', 'medium', 5, 9, 'Prefers high humidity.',
 ...
 'Trim damaged or crispy leaf edges as needed.',
 null,
...
('Anthurium', 'Anthurium andraeanum', 'broadleaf', 'medium', 'medium', 6, 11, 'Enjoys above-average humidity.',
 ...
 'Snip spent waxy blooms at the base to encourage new ones.',
 null,
...
('Fiddle Leaf Fig', 'Ficus lyrata', 'fiddle', 'fussy', 'bright', 8, 16, 'Average humidity; benefits from occasional misting.',
 ...
 'Trim to shape once established; wipe the big leaves regularly so they can photosynthesize.',
 null,
...
('Rubber Plant', 'Ficus elastica', 'fiddle', 'easy', 'bright', 9, 18, 'Average humidity is fine.',
 ...
 'Trim to control height; wipe the glossy leaves to keep them dust-free.',
 null,
...
('Aloe Vera', 'Aloe vera', 'succulent', 'easy', 'bright', 14, 28, 'Prefers dry air — no misting needed.',
 'Fast-draining cactus/succulent mix.', 21, 24,
 ...
 'Snip any mushy or damaged leaves at the base.',
 null,
...
('Jade Plant', 'Crassula ovata', 'succulent', 'easy', 'bright', 14, 28, 'Prefers dry air.',
 ...
 'Prune to shape — it responds well and can be trained into a little tree form.',
 null,
...
('Echeveria', 'Echeveria elegans', 'succulent', 'easy', 'bright', 14, 28, 'Prefers dry air.',
 ...
 'Remove dried lower leaves as the rosette naturally sheds them.',
 null,
...
('String of Pearls', 'Curio rowleyanus', 'string', 'medium', 'bright', 12, 24, 'Prefers dry air.',
 'Fast-draining cactus/succulent mix.', 21, 24,
 'Toxic to cats and dogs.',
 'Lay a trimmed strand across moist soil — new roots form at the nodes within a couple of weeks.',
 'Trim leggy or bare strands to encourage fuller new growth.',
 null,
...
('String of Hearts', 'Ceropegia woodii', 'string', 'easy', 'bright', 12, 24, 'Prefers dry air.',
 'Fast-draining cactus/succulent mix.', 21, 24,
 ...
 'Trim to control length; the trimmings are perfect for propagating more.',
 null,
...
('Chinese Money Plant', 'Pilea peperomioides', 'pilea', 'easy', 'medium', 8, 16, 'Average humidity is fine.',
 ...
 'Rotate regularly instead of pruning; leaves naturally shed from the bottom over time.',
 null,
...
('Dracaena Marginata', 'Dracaena marginata', 'palm', 'easy', 'medium', 10, 20, 'Not fussy about humidity.',
 'Well-draining potting mix.', 21, 24,
 'Toxic to cats and dogs.',
 'Root a cane cutting (a bare stem section) in water or moist soil.',
 'Trim the top to encourage branching; remove any yellowing lower leaves.',
 null,
...
('Areca Palm', 'Dypsis lutescens', 'palm', 'medium', 'bright', 7, 14, 'Enjoys higher humidity; mist occasionally.',
 'Well-draining, slightly rich potting mix.', 14, 20,
 'Non-toxic — safe for pets.',
 'Not typically propagated at home; usually purchased as a multi-stem clump.',
 'Trim entirely brown fronds at the base; leave partially green ones to keep feeding the plant.',
 null,
...
('Parlor Palm', 'Chamaedorea elegans', 'palm', 'easy', 'low', 9, 18, 'Tolerant of average humidity.',
 'Well-draining potting mix.', 14, 24,
 'Non-toxic — safe for pets.',
 'Not typically propagated at home; grown from seed commercially.',
 'Trim only fully brown fronds at the base.',
 null,
...
('Thyme', 'Thymus vulgaris', 'herb', 'easy', 'bright', 7, 14, 'Prefers dry air.',
 ...
 '["Don''t overwater — thyme would rather be too dry than too wet", "Don''t use a rich, moisture-retentive soil — it wants lean and fast-draining"]',
 'seed'),

('Oregano', 'Origanum vulgare', 'herb', 'easy', 'bright', 5, 10, 'Average humidity is fine.',
...
('Parsley', 'Petroselinum crispum', 'herb', 'medium', 'bright', 4, 7, 'Average humidity is fine.',
 ...
 '["Don''t let it dry out completely between waterings", "Don''t try to transplant a mature plant — the taproot rarely survives it"]',
 'seed'),

('Cilantro', 'Coriandrum sativum', 'herb', 'medium', 'bright', 4, 7, 'Average humidity is fine.',
...
('Chives', 'Allium schoenoprasum', 'herb', 'easy', 'bright', 5, 9, 'Average humidity is fine.',
 ...
 '["Don''t let pets nibble it — chives are toxic to cats and dogs even though they''re fine for people", "Don''t harvest the whole clump at once — always leave some growth behind"]',
 'seed'),

('Sage', 'Salvia officinalis', 'herb', 'easy', 'bright', 7, 14, 'Prefers dry air.',
 ...
 '["Don''t overwater — soggy roots are the main risk", "Don''t crowd it into a humid, poorly ventilated spot"]',
 'seed'),

('Lemon Balm', 'Melissa officinalis', 'herb', 'easy', 'medium', 5, 9, 'Average humidity is fine.',
 ...
 '["Don''t let it dry out — leaves wilt quickly", "Don''t plant it in a shared bed or pot — it takes over like mint does"]',
 'seed'),

('Phalaenopsis Orchid', 'Phalaenopsis amabilis', 'orchid', 'medium', 'medium', 7, 10, 'Loves higher humidity — a pebble tray helps.',
 'Chunky orchid bark mix, NOT regular potting soil — roots need airflow.',
 14, 18,
 ...
 'Cut the flower spike above a node after blooms fade to encourage a possible rebloom, or at the base if it yellows.',
 null,
...
('Boston Fern', 'Nephrolepis exaltata', 'fern', 'fussy', 'medium', 4, 7, 'Needs high humidity — mist daily or use a pebble tray.',
 ...
 'Trim any browning fronds at the base — they won''t green back up.',
 null,
